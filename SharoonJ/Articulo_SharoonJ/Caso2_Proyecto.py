...
# Posición inicial del impacto
# (Referencia tomada de la simulación previa)
...
# ============================================================
# CONDICIÓN INICIAL
# CASO 2: PULSO GAUSSIANO DESPLAZADO
# ============================================================
...
print("CASO 2: PULSO GAUSSIANO DESPLAZADO")
print("=" * 60)
...
print(
    f"E(t0 = {t0:5.2f}) = {E_t0:.8f}"
)

print(
    f"E(t1 = {t1:5.2f}) = {E_t1:.8f}"
)

print(
    f"E(t2 = {t2:5.2f}) = {E_t2:.8f}"
)

print(
    f"E(t3 = {t3:5.2f}) = {E_t3:.8f}"
)
